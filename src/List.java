...
public class List {
	...
	/**
	 * If the chr of the given CharData object exists in one of the CharData
	 * objects in this list, removes this CharData object from the list and
	 ...
	 * list.
	 */
	private void addFirst(char chr) {
